...
- (void)setupCustomLayout {
    ...
    [lookupButton setBackgroundColor:[UIColor colorWithRed:0.57 green:0.36 blue:0.85 alpha:1.0]];
...
- (void)bookButtonSelected:(UIButton *)sender {
    [self.navigationController pushViewController:[DatePickerViewController new] animated:YES];
